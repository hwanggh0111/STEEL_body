...
### 포인트
- `--accent`: #ecc089 (주황을 22% 섞은 금)
- `--accent-hover`: #f6cea8 (밝은 금)
- `--accent-low`: #cd9f67 (어두운 금 — 그라디언트의 아래쪽)
- `--accent-dim`: #241a11 (금빛이 도는 어두운 바탕)
- `--on-accent`: #12100c — **금을 통째로 칠했을 때 그 위에 얹는 글자.**
  금이 밝아진 뒤로 흰 글자는 아예 안 보인다 (1.7:1)
