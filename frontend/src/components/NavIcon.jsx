...
const PATHS = {
  ...
  // 막대그래프 — 바닥선 위에 셋
  // 「오늘」 탭 (2026-09-16). 몸 지도가 첫 카드라 사람 모양으로 받는다 —
  // 집 그림은 「여기가 첫 화면」만 말하고, 이 탭이 무엇을 말하는지는 안 알려준다
  body: <><circle cx="12" cy="5.6" r="2.4" /><path d="M8.4 10.4h7.2l-.9 4.6H9.3z" /><path d="M9.6 15 9 20.4M14.4 15l.6 5.4" /><path d="M8.4 11.4 5.6 13M15.6 11.4 18.4 13" /></>,
  ...
  // 새로고침 — 고리 하나에 화살촉 하나. **두 개를 마주보게 그리지 않는다**:
  // 24px 안에서 두 겹이면 16px 로 줄였을 때 뭉개진다 (머리에 들어가는 크기다)
