    ...
    <div style={{
      ...
      <div style={{
        ...
        <svg width="40" height="40" viewBox="0 0 60 60" fill="none" style={{ transform: 'scaleX(-1)' }}>
          <defs><linearGradient id="msL" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#f6cea8"/><stop offset="100%" stopColor="#d18f4a"/></linearGradient></defs>
        ...
        <div style={{
          ...
          filter: 'drop-shadow(0 0 10px rgba(236,192,137,0.4))',
        }}>
          Steel Body
        </div>
        <svg width="40" height="40" viewBox="0 0 60 60" fill="none">
          <defs><linearGradient id="msR" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#f6cea8"/><stop offset="100%" stopColor="#d18f4a"/></linearGradient></defs>
