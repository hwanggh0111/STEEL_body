  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        >
          <defs><linearGradient id="splDb" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#f6cea8"/><stop offset="100%" stopColor="#d18f4a"/></linearGradient></defs>
        ...
        <div style={{ textAlign: 'center' }}>
          <div style={{
            ...
            filter: `drop-shadow(0 0 ${phase === 1 ? '20' : '8'}px rgba(236,192,137,${phase === 1 ? '0.6' : '0.3'}))`,
            transition: 'all 0.8s cubic-bezier(0.4, 0, 0.2, 1)',
          }}>
            STEEL BODY
          </div>
      ...
      <div style={{
        ...
        height: 300,
        borderRadius: '50%',
        background: 'radial-gradient(circle, rgba(236,192,137,0.15) 0%, transparent 70%)',
        opacity: phase === 1 ? 1 : 0,
