...
// **2026-09-01 에 앱 이름을 IRONLOG 로 정하면서 도로 ironlog 로 맞췄다.**
// 그래서 지금은 여기 `ironlog_` 열쇠들이 앱 이름과 다시 짝이 맞는다.
// 다만 `steelbody_` 로 시작하는 열쇠 몇은 **그대로 둔다** — 이름은 아무 데도
// 안 보이는데, 바꾸면 쓰던 사람의 휴식 타이머 설정과 답변 확인 시각이 사라진다.
// 브라우저에 남겨두는 것들의 이름.
//
