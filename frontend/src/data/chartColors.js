...
// 쓰지만 그래프는 못 쓴다 — 색이 SVG **속성**으로 나가는데(`<text fill="...">` ·
// `<path stroke="...">`) 속성 안에서는 var() 가 치환되지 않는다. 값이 통째로
// 무시되면서 글씨는 검정, 선은 아예 안 그려진다. 화면은 아무 말도 안 하고
// 그래프만 조용히 비어 보인다. (2026-08-27 까지 실제로 그 상태였다)
//
