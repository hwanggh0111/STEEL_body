...
const TYPE_NOTE = {
  ...
  // **「기능성운동」 화면에도 같은 이름의 판이 있다.** 9/3 까지는 운동까지 똑같아서
  // 두 화면을 다 본 사람에게는 같은 것이 두 군데 있는 것으로 보였다. 이제 역할로 가른다 —
  // 여기는 **적어두고 기록하는** 목록(배낭 · 문틀바 · 체력검정까지),
  // 저기는 **준비물 없이 켜서 따라 하는** 10분 한 판이다. 운동도 안 겹친다
  '기능성': '집에서 하는 특수부대식 훈련입니다. 세트 · 횟수로 적어두고 기록하는 목록이에요 — '
    + '책 넣은 배낭과 문틀바를 쓰고, 2분 팔굽혀펴기 같은 체력검정 항목도 들어갑니다. '
    + '준비물 없이 시간만 재며 따라 하고 싶으면 「기능성운동」 화면의 같은 이름 판을 켜세요 (운동은 서로 다릅니다). '
